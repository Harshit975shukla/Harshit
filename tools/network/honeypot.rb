=begin
this is a honeypot created by Harshit shukla for JECRC university
...
title "// Honeypot //"
puts ""
warning "You must run it with root privileges.\n"
puts ""
puts " Select option."
puts ""
...
case configuration
	...
	when "2"
		...
		if log == "Y" || log == "y"
			...
			puts ""
			puts "Default: */Harshitproject/other/log_honeypot.txt"
			puts ""
			print "   -> "
